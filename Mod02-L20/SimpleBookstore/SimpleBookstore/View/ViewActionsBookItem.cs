...
{
  public class ViewActionsBookItem
  {
    //--------------------------------------------------
    public ViewActionsBookItem() { }

    //-------------------------------------------------------
    public void ShowBookList(List<BookItem> booksList)
    {
      Console.WriteLine("-----------------------");
    ...
    //---------------------------------------------------------
    public void ShowBook(BookItem book)
    {
      string bookView = "";
    ...
    //----------------------------------------------------------------
    public BookItem EditBook(BookItem currentBook)
    {
      BookItem editedBook = new BookItem();
